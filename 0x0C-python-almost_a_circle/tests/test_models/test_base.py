#!/usr/bin/python3
""" Tests Base Rectangle Square classes """
import unittest
...
class TestBase(unittest.TestCase):
    ...
    def test_string_id(self):
        base_instance = Base("Tic Tak")
        self.assertEqual(base_instance.id, "Tic Tak")
        base_instance = Base("Kuruko no Basket")
        self.assertEqual(base_instance.id, "Kuruko no Basket")
